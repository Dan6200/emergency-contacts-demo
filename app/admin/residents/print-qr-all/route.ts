export {};
//import { getAllResidentsDataLite } from "@/app/admin/residents/data-actions";
...
//
//  await Promise.all(
//    AllResidents.slice(0, 10).map(
//      async ({ id, unit_number, address }: Resident, idx) => {
...
//        doc.text("#" + unit_number, 120, 173); // Adjust position
//
...
//
//        if (idx < AllResidents.length - 1) doc.addPage(); // Add new page for next resident
//      }
//    )
//  );
//
